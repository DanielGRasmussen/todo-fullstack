...
const todos: ITodoData[] = [
	{
		...
		type: "General",
		subTasks: [
			{ name: "", link: true, id: "19384" },
			{ name: "Eat the sandwich", link: false, id: "" }
		],
		priority: "4",
		status: "complete",
	...
	},
	{
		...
		type: "General",
		subTasks: [
			{ name: "Go to bed", link: false, id: "" },
			{ name: "Wake up refreshed", link: false, id: "" }
		],
		priority: "5",
		status: "complete",
	...
	},
	{
		...
		type: "Health",
		subTasks: [
			{ name: "Put on running shoes", link: false, id: "" },
			{ name: "Run for 30 minutes", link: false, id: "" },
			{ name: "Stretch", link: false, id: "" }
		],
		priority: "3",
		status: "incomplete",
	...
	},
	{
		...
		type: "Learning",
		subTasks: [
			{ name: "Choose a book", link: false, id: "" },
			{ name: "Read for 30 minutes", link: false, id: "" },
			{ name: "Take notes", link: false, id: "" }
		],
		priority: "2",
		status: "incomplete",
	...
	},
	{
		...
		subTasks: [
			{ name: "Stretch", link: false, id: "" },
			{ name: "Warm up", link: false, id: "" },
			{ name: "Cool down", link: false, id: "" }
		],
		priority: "3",
		status: "in-progress",
	...
	},
	{
		...
		type: "Work",
		subTasks: [
			{ name: "Write introduction", link: false, id: "" },
			{ name: "Add charts and graphs", link: false, id: "" },
			{ name: "Proofread", link: false, id: "" }
		],
		priority: "2",
		status: "in-progress",
	...
	},
	{
		...
		type: "Personal",
		subTasks: [
			{ name: "Make the call", link: false, id: "" },
			{ name: "Ask about her day", link: false, id: "" },
			{ name: "Tell her about yours", link: false, id: "" }
		],
		priority: "4",
		status: "incomplete",
	...
	},
	{
		...
		type: "Chores",
		subTasks: [
			{ name: "Make a list", link: false, id: "" },
			{ name: "Go to the store", link: false, id: "" },
			{ name: "Check off items", link: false, id: "" }
		],
		priority: "5",
		status: "in-progress",
